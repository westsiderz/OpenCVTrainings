...
// Apply the Sobel filter to an image using spatial gradient
void applySpatialGradient()
{
    // Path to the input image
    std::string l_pathToInputImage{ "../Resources/youngBlood.jpg" };
    ...
    spatialGradient(l_image, l_xSobel, l_ySobel, c_size);
